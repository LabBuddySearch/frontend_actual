...
export function TeacherLayout() {
  ...
  const NavItems = (
    <>
      <NavLink className={navLinkClass} end to="/teacher" onClick={closeMobile}>
        <LayoutDashboard aria-hidden className="size-[22px]" strokeWidth={1.75} />
        Главный экран
      </NavLink>
      <NavLink className={navLinkClass} to="/teacher/profile" onClick={closeMobile}>
          ...
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden text-right sm:block">
                <p className="text-sm font-semibold">Здравствуйте, {fullName || 'коллега'}!</p>
